...
from config import prRed, prGreen, _results_dir_pathlib
...
class ImageEditor(object):
    ...
    def save_current_img(self, target_file_name):
        target_file_path = self.target_directory / f"{target_file_name}{self.current_img_path.suffix}"
        self.current_img.save(target_file_path)

    def insert_rectangle_to_image(self, rectangle_fill_color="black",
                                  x_coord=None, y_coord=None, rectangle_height=None,
                                  rectangle_width=None, outline_color=None, outline_width=None):
        ...
        draw.rectangle(xy=(x_coord, y_coord, x_coord + rectangle_width, y_coord + rectangle_height),
                       fill=rectangle_fill_color, outline=outline_color, width=outline_width)
...
if __name__ == "__main__":
    ...
    editor.insert_rectangle_to_image(x_coord=0, y_coord=0,
